...
C<attachment()> method of L<RT::Client::REST::Ticket> object to get
...
=item retrieve (parent_id => $parent_id, id => $id)

B<parent_id> is usually the ticket ID attachment is associated with, B<id>
is the numeric id of the particular attachment.
